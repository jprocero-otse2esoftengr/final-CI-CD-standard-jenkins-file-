            ...
            steps {
                dir('.') {
                    bat """
                        ...
                        echo Deploying with overwrite option and control port ${params.CONTROL_PORT}...
                        npx e2e-bridge-cli deploy repository/BuilderUML/regtestlatest.rep -h ${params.BRIDGE_HOST} -u ${params.BRIDGE_USER} -P ${params.BRIDGE_PASSWORD} -o overwrite --controlport ${params.CONTROL_PORT}
                        ...
                        echo Starting the service with control port ${params.CONTROL_PORT}...
