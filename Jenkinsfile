            ...
            steps {
                dir('.') {
                    bat """
                        ...
                        echo First, checking and stopping any existing instance...
                        npx e2e-bridge-cli stop regtestlatest -h ${params.BRIDGE_HOST} -u ${params.BRIDGE_USER} -P ${params.BRIDGE_PASSWORD} 2>nul || echo "No existing instance to stop (this is normal for first deployment)"
                        ...
                        echo Starting the service after deployment...
