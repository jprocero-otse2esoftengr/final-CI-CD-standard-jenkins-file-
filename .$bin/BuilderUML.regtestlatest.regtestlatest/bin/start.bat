...
set INSTANCES_HOME=C:\Users\jproc\Music\final-CI-CD-standard-jenkins-file-\.$bin
set INSTANCE_HOME=C:\Users\jproc\Music\final-CI-CD-standard-jenkins-file-\.$bin\BuilderUML.regtestlatest.regtestlatest
...
rem start server
"%BRIDGESERVER_BIN%\bridgeserver.exe" repository "%INSTANCE_HOME%\repository\tabfiles"
